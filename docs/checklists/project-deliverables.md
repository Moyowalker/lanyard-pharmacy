...
- [ ] Persist notification delivery attempts and worker-side audit trails.
- [ ] Process order, payment, inventory, and prescription events end to end across API and worker.
